    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        >
          ...
          <p className="mb-4">
            Il Fondaco dei Longobardi è ubicato nel porto di Trani, città conosciuta come la "Perla dell'Adriatico" e famosa per la Cattedrale che sorge maestosa direttamente sul mare e il Castello Svevo.
          </p>
          <div className="space-y-4 mb-6">
            <div className="flex items-center">
              <Mail className="text-brand-secondary mr-2" />
              <span>info@fondacodeilongobardi.it</span>
            </div>
            <div className="flex items-center">
