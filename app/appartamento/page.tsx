...
export default function Appartamento() {
  ...
  return (
    <div className="w-full overflow-x-hidden">
      ...
      */}
      <motion.section
        className="relative w-screen min-h-screen flex flex-col justify-center items-center px-8 py-12 overflow-y-auto"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      */}
      <motion.section
        className="relative w-screen min-h-screen flex justify-center items-center bg-gray-100"
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
        transition={{ duration: 0.6 }}
      >
        {/* Sfondo con immagine slider */}
        ...
        {/* Pulsanti freccia */}
        <button
          className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white/80 p-4 rounded-full shadow-md hover:bg-white transition-colors"
          onClick={prevImage}
        ...
        <button
          className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white/80 p-4 rounded-full shadow-md hover:bg-white transition-colors"
          onClick={nextImage}
      ...
      {/*
        SEZIONE 3 - DETTAGLI APPARTAMENTO (layout standard, se vuoi puoi mettere anche qui h-screen)
      */}
      <motion.section
